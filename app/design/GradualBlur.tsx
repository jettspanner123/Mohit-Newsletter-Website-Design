...
const GradualBlur: React.FC<GradualBlurProps> = (props) => {
  ...
  const { hoverIntensity, animated, onAnimationComplete, duration } =
    config as GradualBlurProps & { duration: string };
...
(GradualBlurMemo as React.MemoExoticComponent<React.FC<GradualBlurProps>> & {
...
// Inject minimal base styles once on the client
const injectStyles = () => {
